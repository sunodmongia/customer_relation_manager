...
urlpatterns = [
    ...
    path("lead/<int:pk>/update_status/", UpdateLeadStatusView.as_view(), name="update_status"),
    # urls for agents
    ...
    path("<int:pk>/update_status/", UpdateAgentStatusView.as_view(), name="agent_update_status"),
